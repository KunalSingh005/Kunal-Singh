...
export const CERTIFICATE_CATEGORIES: CertificateCategory[] = [
    ...
    },
    {
        ...
        certificates: [
            ...
            { title: 'Google Cybersecurity Professional Certificate', description: 'Completed 8-course program covering Python, Linux, SQL, SIEM tools, and IDS for entry-level cybersecurity roles.', tags: ['Security', 'Google', 'SIEM'], url: 'https://coursera.org/verify/professional-cert/B9G8FMANN712', imageUrl: '/certificates/Google Cybersecruity Certificate conv 1.jpeg' },     
        ],
    },
    {
